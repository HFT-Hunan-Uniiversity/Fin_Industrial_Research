...
| Agent           | 功能                                                                            |
| --------------- | ------------------------------------------------------------------------------- |
| MacroAgent      | 宏观经济关联分析 分析 GDP、CPI、利率等宏观指标对行业的影响。                    |
| FinanceAgent    | 企业财务分析 解析行业龙头（如宁德时代、比亚迪）的财报，评估行业健康度。         |
| MarketAgent     | 市场产销与竞争分析 分析月度产销数据、市场份额、竞争格局（传统车企 vs 新势力）。 |
| PolicyNewsAgent | 政策环境评估解读国家及地方补贴、碳排放政策、技术路线图和新闻舆情等。            |
| ForecastAgent   | 未来趋势预测基于历史数据与当前趋势，预测市场规模、技术发展方*向。*            |
| ReportAgent     | *报告整合与生成统筹所有智能体结论，撰写结构完整、图文并茂的最终报告*          |
